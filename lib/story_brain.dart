...
class StoryBrain {
  ...
  nextStory(int choiceNumber) {
    if (choiceNumber == 1 && _storyNumber == 0) {
      return _storyData[storyBrain._storyNumber = 2];
    }
    if (choiceNumber == 2 && _storyNumber == 0) {
      return _storyData[storyBrain._storyNumber = 1];
    }
    if (choiceNumber == 1 && _storyNumber == 1) {
      return _storyData[storyBrain._storyNumber = 2];
    }
    if (choiceNumber == 2 && _storyNumber == 1) {
      return _storyData[storyBrain._storyNumber = 3];
    }
    if (choiceNumber == 2 && _storyNumber == 2) {
      // here
      return _storyData[storyBrain._storyNumber = 4];
    }
    if (choiceNumber == 1 && _storyNumber == 2) {
      return _storyData[storyBrain._storyNumber = 5];
    }
    if (choiceNumber == 2 && _storyNumber == 2) {
      return _storyData[storyBrain._storyNumber = 4];
    }
    if (choiceNumber == 1 && _storyNumber == 3) {
      return storyBrain.restart();
    }
...
//Done: Step 6 - import the story.dart file into this file. Done

//Done: Step 5 - Create a new class called StoryBrain. Done

//Done: Step 7 - Uncomment the lines below to include storyData as a private property in StoryBrain. Hint: You might need to change something in story.dart to make this work.Done
